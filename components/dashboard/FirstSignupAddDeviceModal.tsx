...
import FirstSignupCreateProgramModal from "./FirstSignupCreateProgramModal";
...
interface FirstSignupAddDeviceModalProps {
  isOpen: boolean;
  onClose: () => void;
  programId?: string;
  onSuccess?: () => void;
...
function FirstSignupAddDeviceModal({ isOpen, onClose, programId, onSuccess, forceShowProgram }: FirstSignupAddDeviceModalProps) {
  ...
  const { data: programsData, isLoading: isLoadingPrograms } = useGetAllProgramsDataQuery(undefined);
...
export default FirstSignupAddDeviceModal;
