...
> = async (args, api, extraOptions) => {
    ...
    if (errorStatus === 401 || errorStatus === '401') {
      ...
      // Final Cleanup: If no refresh token, refresh failed, or retry failed
...
//   endpoints: () => ({}),
//   tagTypes: ["User", "NotificationPermission", "Notification", "Activity", "Content", "Devices", "Programs", "Schedules", "Device", "AdminSettings", "Subscription", "UserPlans", "ReportHub", "ReportHistory", "Banner", "Billing", "SupportTicket", "AdminSupportTicket", "AdminEmployee", "AdminSupporter", "SupporterTicket", "SupporterTicketStats", "FAQ", "VideoFAQ", "Preferences", "FinancialData", "Tax", "SupporterTag", "TicketTag", "AdditionalPayment", "AdditionalPaymentSigner"],
// });
