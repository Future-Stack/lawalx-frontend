...
const plans = [
  {
    ...
    buttonColor: "bg-[#111827] dark:bg-white dark:text-[#111827] text-white hover:bg-slate-800 dark:hover:bg-slate-200 shadow-customShadow",
    borderColor: "border-border",
    cardStyle: "bg-cardBackground",
  },
  {
    title: "Business",
    ...
    <div className="min-h-screen px-4 py-10 sm:px-6 lg:px-10">
      <div className="mx-auto w-full max-w-7xl">
        <div className="mb-8">
          ...
          >
            <div className="flex items-center justify-center w-10 h-10 rounded-full border border-border bg-cardBackground shadow-sm transition-all group-hover:bg-blue-50 group-hover:border-bgBlue/30 dark:group-hover:bg-blue-900/20">
        ...
        <div className="">
          ...
          <div className="relative z-10 text-center mx-auto max-w-3xl mb-12">
            ...
            <h1 className="text-[40px] font-bold leading-tight text-headings" style={{ fontFamily: "Inter" }}>
              Choose Your Plan
            </h1>
            <p className="mt-4 text-[16px] leading-[24px] text-muted" style={{ fontFamily: "Inter" }}>
          ...
          <div className="relative z-10 mb-10 flex items-center justify-center gap-4">
            ...
            <button
              ...
              className={`relative h-[24px] w-[44px] rounded-full p-1 transition-colors duration-300 ${isAnnual ? "bg-[#22C55E]" : "bg-[#D4D4D4] dark:bg-[#404040]"} cursor-pointer focus:outline-none`}
          ...
          <div className="grid gap-8 xl:grid-cols-3 justify-items-center">
            {plans.map((plan) => {
              ...
              return (
                  <div
                  key={plan.title}
                  className={`relative flex w-full flex-col overflow-hidden rounded-[16px] border ${plan.cardStyle} transition-all duration-300 ${plan.borderColor} ${selected ? "ring-2 ring-slate-900 dark:ring-slate-100" : ""}`}>
                  
                  {/* Header Section */}
                  <div className="p-6">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-4">
                        <h2 className="font-inter text-[18px] font-semibold leading-normal text-headings">{plan.title}</h2>
                        {plan.highlight && (
                      ...
                      <p className="font-inter text-[14px] font-normal leading-[20px] text-muted">{plan.description}</p>
                    </div>
                  </div>
                  ...
                  <div className="p-6 space-y-6">
                    <Select value={selectedSize} onValueChange={setSelectedSize}>
                      <SelectTrigger className="flex w-full items-center justify-between rounded-[12px] border border-border bg-cardBackground px-5 py-[14px] h-auto text-sm font-medium text-body transition hover:bg-slate-50 dark:hover:bg-slate-800 focus:ring-0 outline-none">
                        <SelectValue placeholder="Select size" />
                      </SelectTrigger>
                      <SelectContent className="bg-cardBackground border-border">
                    ...
                    <div className="flex w-full items-baseline justify-center gap-1 rounded-[8px] bg-cardBackground2 px-4 py-4">
                      <span className="font-inter text-[24px] font-semibold leading-normal text-headings">₦{value}</span>
                      <span className="font-inter text-[14px] font-normal leading-[20px] text-muted">{label}</span>
                    </div>
                  </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-5">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-inter text-[14px] font-semibold leading-[20px] text-headings">20</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-inter text-[14px] font-semibold leading-[20px] text-headings">10 GB</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 border-y border-border py-5">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-inter text-[14px] font-semibold leading-[20px] text-headings">Max 20 Files</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-inter text-[14px] font-semibold leading-[20px] text-headings">1</p>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="relative z-10 mt-12 overflow-hidden rounded-[24px] border border-border p-6 shadow-sm flex flex-col lg:flex-row items-center gap-10 justify-between add-bg-img bg-cardBackground">
