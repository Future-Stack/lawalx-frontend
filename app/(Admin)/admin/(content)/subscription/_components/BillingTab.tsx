...
const STATUS_STYLES: Record<PaymentStatus, string> = {
    PENDING: "text-amber-600 bg-amber-50 border-amber-200 dark:bg-amber-900/20 dark:border-amber-800 dark:text-amber-400",
    SUCCESS: "text-green-600 bg-green-50 border-green-200 dark:bg-green-900/20 dark:border-green-800 dark:text-green-400",
    REFUNDED: "text-purple-600 bg-purple-50 border-purple-200 dark:bg-purple-900/20 dark:border-purple-800 dark:text-purple-400",
    PARTIALLY_REFUNDED: "text-blue-600 bg-blue-50 border-blue-200 dark:bg-blue-900/20 dark:border-blue-800 dark:text-blue-400",
    CANCELLED: "text-red-600 bg-red-50 border-red-200 dark:bg-red-900/20 dark:border-red-800 dark:text-red-400",
};
...
const BillingTab = () => {
    ...
    const [triggerViewInGateway, { isLoading: isGatewayLoading }] =
        useLazyViewInGatewayQuery();
    ...
    const handleViewInGateway = async (paymentId: string) => {
        try {
            ...
            // Gateway URL fetch failed silently — could add toast here
        } finally {
                    ...
                    <TableBody>
                        ...
                        {payments.map((payment) => (
                            ...
                            >
                                ...
                                {/* User */}
                                <TableCell>
                                    <div className="font-medium text-headings">{payment.user.name}</div>
