...
import { MoreVertical, FileText, XCircle, ArrowUpCircle, Search, Loader2 } from "lucide-react";
...
const SubscribersTab = () => {
    ...
    return (
        <div className="space-y-6">
                            ...
                            <TableBody>
                                {subscribers.map((sub) => (
                                    <TableRow key={sub.userId}>
                                        ...
                                        <TableCell className="text-headings">{sub.paymentCycle}</TableCell>
                                        <TableCell className="text-muted">{formatDate(sub.nextBilling)}</TableCell>
                                        <TableCell>
                                            <Badge
                                                variant="default"
                                        ...
                                        <TableCell>
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end">
                                                    <DropdownMenuItem onClick={() => handleViewInvoices(sub.userId)}>
            ...
            {/* Transaction Sheet */}
            <TransactionSheet open={sheetOpen} setOpen={setSheetOpen} userId={selectedUserId} />
        </div>
    );
};
