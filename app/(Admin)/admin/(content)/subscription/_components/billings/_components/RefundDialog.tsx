...
import { useProcessRefundMutation, ProcessRefundRequest } from "@/redux/api/admin/refund/refundApi";
...
const RefundDialog = ({ open, setOpen, payment }: RefundDialogProps) => {
    const [refundType, setRefundType] = useState<ProcessRefundRequest["refundType"]>("FULL");
    const [reason, setReason] = useState<ProcessRefundRequest["reason"]>("DUPLICATE_CHARGE");
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <BaseSelect
                        ...
                        value={refundType}
                        onChange={(v) => setRefundType(v as ProcessRefundRequest["refundType"])}
                ...
                <div className="space-y-3">
                    ...
                    <BaseSelect
                        ...
                        options={[
                            ...
                            { label: "Service Dissatisfaction", value: "SERVICE_DISSATISFACTION" },
