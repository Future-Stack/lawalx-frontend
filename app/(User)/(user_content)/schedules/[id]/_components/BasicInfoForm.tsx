            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full px-3.5 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900 placeholder:text-gray-400 transition-colors resize-none"
                    />
                </div>
            </div>
        </section>
