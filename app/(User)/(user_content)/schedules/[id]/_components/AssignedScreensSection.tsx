    ...
    return (
        <section className="bg-navbarBg border border-border rounded-xl p-6 space-y-6 shadow-sm">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <button
                    onClick={onAddScreen}
                    className="w-full sm:w-auto flex items-center justify-center gap-2 px-4 py-2 md:py-2.5 bg-bgBlue text-white text-base font-semibold rounded-lg hover:bg-blue-500 transition cursor-pointer shadow-customShadow"
                >
                ...
                {assignedDevices.map((device: any) => (
                    <div key={device.id} className="py-4 flex justify-between items-center gap-4 shadow-sm px-4 rounded-lg">
                        ...
                        <button
                            ...
                            className="justify-self-end p-1 hover:bg-red-50 rounded-full transition-colors text-red-500 cursor-pointer shrink-0"
                ...
                <div className="mt-8 p-6 bg-red-50/50 dark:bg-red-900/5 border-none rounded-2xl space-y-4">
                    ...
                    <div className="flex justify-end pt-2 w-full">
                        <button
                            ...
                            className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3 bg-[#F43F5E] hover:bg-red-600 text-white rounded-lg font-bold transition-all shadow-customShadow cursor-pointer"
                        >
