  ...
  return (
    <div className="bg-navbarBg border border-border rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-4 sm:px-5 py-4 border-b border-border">
        <h2 className="text-base font-semibold text-headings whitespace-nowrap">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 px-4 sm:px-5 py-4 border-t border-border">
        <p className="text-xs sm:text-sm text-center sm:text-left text-muted">
        ...
        <div className="flex items-center justify-center gap-1 flex-wrap">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 sm:px-3 sm:py-1.5 text-xs sm:text-sm rounded-lg border border-border text-muted hover:bg-bgGray dark:hover:bg-gray-800/50 disabled:opacity-40 disabled:cursor-not-allowed transition-colors cursor-pointer"
          >
          ...
          {pageNumbers.map((p, i) =>
            p === "..." ? (
              <span
                key={`ellipsis-${i}`}
                className="px-1.5 sm:px-2 py-1 text-xs sm:text-sm text-muted"
              >
                ...
              </span>
            ) : (
              <button
                ...
                className={cn(
                  ...
                  currentPage === p
                    ...
                    : "border border-border text-muted hover:bg-bgGray dark:hover:bg-gray-800/50",
                )}
              >
                {p}
              </button>
