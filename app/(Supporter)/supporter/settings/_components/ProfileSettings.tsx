    ...
    <div className="w-full mx-auto py-6 sm:py-10 px-4 sm:px-6">
      ...
      <div className="flex flex-col items-center justify-center mb-10">
        <div className="relative mb-4">
          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border-[3px] border-white shadow-sm bg-bgGray">
            <img
              src={profileImg}
              alt="Profile Picture"
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-headings">
          {userName}
        </h2>
      </div>
      ...
      <div className="flex justify-center mb-8 sm:mb-12">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full max-w-xl">
          <TabsList className="flex sm:grid w-full sm:grid-cols-3 h-auto sm:h-15 bg-navbarBg border border-[#0FA6FF] dark:border-blue-900/50 rounded-xs p-1 overflow-x-auto scrollbar-hide">
            <TabsTrigger
              value="edit-profile"
              className="flex-1 min-w-fit sm:min-w-0 rounded-xs border-none text-gray-600 dark:text-gray-400 data-[state=active]:bg-[#1EA1F2] data-[state=active]:text-white dark:data-[state=active]:text-white data-[state=active]:shadow-sm text-xs sm:text-sm font-medium transition-all py-2.5 sm:py-0 sm:h-full px-4 sm:px-0 whitespace-nowrap"
            >
              Edit Profile
            </TabsTrigger>
            <TabsTrigger
